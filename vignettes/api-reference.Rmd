...
vignette: >
  %\VignetteIndexEntry{RandomWalker API Reference}
...
```{r rw30_visualize, fig.width=7, fig.height=4}
#| fig.alt: >
#|   Visualize 30 random walks
# Visualize
...
**Examples:**
```{r visualize_basic, fig.width=7, fig.height=4}
#| fig.alt: >
#|   Basic visualization of random walks
# Basic visualization
rw30() |> visualize_walks()
```

```{r visualize_alpha, fig.width=7, fig.height=4}
#| fig.alt: >
#|   Random walks with adjusted transparency
# Adjust transparency
...
- `.window`: Window size (positive integer; number of points to include in each running quantile calculation)
